...
from configs import TaylorHood_poly_init_noDiv_noise_implicitEuler as cf
...
def generate() -> None:
    ...
    # define data
    initial_condition = get_function(cf.INITIAL_CONDITION_NAME,space_disc)
    noise_coefficient = get_function(cf.NOISE_COEFFICIENT_NAME,space_disc)
    ...
    for k in new_seeds:
        ...
        ref_to_noise_increments, ref_to_time_to_velocity, ref_to_time_to_pressure = generate_one(time_disc,space_disc,initial_condition,noise_coefficient,algorithm,sampling_strategy)
